...
public class OsmService {
    ...
    private static final String OSM_DETAILS_URL
            = "https://nominatim.openstreetmap.org/details.php?place_id=%d&addressdetails=1&hierarchy=0&group_hierarchy=1&format=json";
    ...
    public OsmDetails getComuneById(long id) throws Exception {
        if(id <= 0) {
            throw new Exception("Compilare tutti i campi");
        }
        String url = String.format(OSM_DETAILS_URL, id);
        String json = makeHttpCall(url);
